...
namespace Basics.AI.NeuralNetworks
{
    ...
    {
        //public static ActivationFunction BinaryStep(double threshold, double outputBeforeThreshold, double outputAfterThreshold)
        //{
        //    return input => input < threshold ? outputBeforeThreshold : outputAfterThreshold;
        //}
